...
const Footer = () => {
  ...
  return (
    <div className='footer'id='footer'>
      <h1>🌐Dhabata beleda dalalu✅</h1>
      <img className='logos' src={assets.group1} alt="" />
...
<a href='/'><button >🔙Dubatti debi'i</button></a>
<hr />
      </div>
      <p className="footer-copyright">
        {new Date().getFullYear()}©️Garee 5ffaa cufaan Qophaa'ee</p>
